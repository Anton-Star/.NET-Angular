module app.Annual {
    ...
    class ApplicationController implements IApplication {
        ...
        getApplication(): ng.IPromise<void> {
            return this.applicationService.getApplication(this.org, this.applicationType)
        ...
        getApp(): ng.IPromise<void> {
            ...
            return this.applicationService.getApplicationSections(this.org, this.applicationType)
        ...
        submit(): void {
            ...
            this.applicationService.submitApplication(this.org, this.applicationType)
